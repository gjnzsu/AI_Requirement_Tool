...
class DeepSeekAdapter(BaseProviderAdapter):
    ...
    async def generate_completion(
        ...
        """
        Generate completion using DeepSeek provider.
        ...
        try:
            ...
            raise TimeoutError(f"DeepSeek request timed out after {timeout or 60.0} seconds")
        except Exception as e:
            raise Exception(f"DeepSeek provider error: {str(e)}") from e
