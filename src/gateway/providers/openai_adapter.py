...
class OpenAIAdapter(BaseProviderAdapter):
    ...
    async def generate_completion(
        ...
        """
        Generate completion using OpenAI provider.
        ...
        try:
            ...
            raise TimeoutError(f"OpenAI request timed out after {timeout or 60.0} seconds")
        except Exception as e:
            raise Exception(f"OpenAI provider error: {str(e)}") from e
